...
<form action="update.do" method="post" id="writeForm">
	...
	<h1><i class="fa fa-eraser"></i>일반 게시판 글 수정</h1>
		...
		<button type="button" class="btn btn-secondary cancelBtn" onclick="location='/board/view.do?no=${imageVO.no }&inc=0&page=${param.page }&perPageNum=${param.perPageNum }&key=${param.key }&word=${param.word }'">취소</button>	
		</div>	
</form>
</div>
</body>
